describe("Maps", function () {
    ...
    it("should return the value when get is called with correct key", function () {
        var map = new Map();
        map.set("age", 36);
        expect(map.get("age")).toBe(36);
    });
    ...
    it("should contain items when given an array in the constructor", function () {
        //array of arrays each item containing an array with 2 elements (key, value)
    ...
    it("should not allow duplicate keys", function () {
        ...
        map.set(key, 'first');
        map.set(key, 'second');
        expect(map.get(key)).toBe('second'); //first gets replaced with second
    });
    ...
    it("should return an iterator of arrays of key value pais when entries is called", function () {
        var map = new Map();
        map.set('name', 'Joe');
